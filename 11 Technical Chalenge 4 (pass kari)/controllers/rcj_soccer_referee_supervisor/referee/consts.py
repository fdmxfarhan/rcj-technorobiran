...
BALL_DEPTH = 0
BALL_INITIAL_TRANSLATION = [0.45, -0.3, BALL_DEPTH]
...
ROBOT_INITIAL_TRANSLATION = {
    "B1": [0.5, 0.6, OBJECT_DEPTH],
    "B2": [-0.5, 0.6, OBJECT_DEPTH],
    "B3": [0, 0.75, OBJECT_DEPTH],
    "Y1": [0.5, -0.6, OBJECT_DEPTH],
    "Y2": [-0.5, -0.6, OBJECT_DEPTH],
    "Y3": [0, -0.75, OBJECT_DEPTH],
}
...
BLUE_KICKOFF_TRANSLATION = [0, 0.75, OBJECT_DEPTH]
YELLOW_KICKOFF_TRANSLATION = [0, -0.75, OBJECT_DEPTH]
...
LACK_OF_PROGRESS_NUMBER_OF_NEUTRAL_SPOTS = 0
